      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/privacypolicy" className="hover:text-[#00ffbf] transition">Privacy Policies</Link></li>
            <li><Link to="/hangtight" className="hover:text-[#00ffbf] transition">Track your Order</Link></li>
            <li><Link to="/pricing" className="hover:text-[#00ffbf] transition">Pricing</Link></li>
            <li><Link to="/hangtight" className="hover:text-[#00ffbf] transition">FAQ</Link></li>
          </ul>
        </div>
